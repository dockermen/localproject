...
lk = linkkit.LinkKit(
    ...
    product_key="k1qgqYROE3f",
    device_name="Z3yyTD0CtesV0KtiB7ql",
    device_secret="1c57f860f4e4837ba7c01a93f19c929d")
...
lk.config_mqtt(secure="",endpoint="iot-06z00ga01v5k4hc.mqtt.iothub.aliyuncs.com")
#lk.connect_async()
